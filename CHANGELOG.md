...
- Got rid of static method `JobExecutionCounts.query()` for using native MySql syntax. To provide this functionality we will use the _terms_ and _stats_ feature of [coodoo-listing v1.6.0](https://github.com/coodoo-io/coodoo-listing)
...
- `JobEngineUtil.getAvailableWorkers()` because doesn't work proper _(will be removed in the future!)_
...
- MySQL script: Reduced `worker_class_name` column length to 255 to avoid _Error Code: 1071. Specified key was too long; max key length is 767 bytes_
