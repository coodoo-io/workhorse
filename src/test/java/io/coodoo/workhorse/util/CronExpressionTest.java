...
public class CronExpressionTest {
    ...
    public void shall_ignore_field_in_day_of_week() throws Exception {
        ...
        assertTrue("day of week is ?", field.matches(LocalDateTime.now().toLocalDate()));
    }
    ...
    public void check_dayOfMonth_number_last_L() throws Exception {
        ...
        LocalDateTime after = LocalDateTime.of(2012, 4, 10, 13, 0, 0, 0);
        LocalDateTime expected = LocalDateTime.of(2012, 4, 30 - 3, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));

        after = LocalDateTime.of(2012, 2, 12, 0, 0, 0, 0);
        expected = LocalDateTime.of(2012, 2, 29 - 3, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));
    }
    ...
    public void check_dayOfWeek_number() throws Exception {
        ...
        LocalDateTime expected = LocalDateTime.of(2012, 4, 4, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));
        ...
        expected = LocalDateTime.of(2012, 4, 18, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));

        after = LocalDateTime.of(2012, 4, 18, 0, 0, 0, 0);
        expected = LocalDateTime.of(2012, 4, 25, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));
    }
    ...
    public void check_dayOfWeek_increment() throws Exception {
        ...
        after = LocalDateTime.of(2012, 4, 8, 0, 0, 0, 0);
        expected = LocalDateTime.of(2012, 4, 11, 0, 0, 0, 0);
        assertTrue(cronExpr.nextTimeAfter(after).equals(expected));
    }
    ...
    public void check_dayOfWeek_last_friday_in_month() throws Exception {
        ...
        after = LocalDateTime.of(2012, 4, 27, 0, 0, 0, 0);
    ...
    public void check_dayOfWeek_shall_interpret_0_as_sunday() throws Exception {
        LocalDateTime after = LocalDateTime.of(2012, 4, 1, 0, 0, 0, 0);
        LocalDateTime expected = LocalDateTime.of(2012, 4, 8, 0, 0, 0, 0);
        assertTrue(new CronExpression("0 0 0 * * 0").nextTimeAfter(after).equals(expected));

        expected = LocalDateTime.of(2012, 4, 29, 0, 0, 0, 0);
